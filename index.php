...
?>
	...
	<div class="banner-bottom">
		<div class="container">
			<h4>CDC <span>Center For</span> Disease Control </h4>
			<p>The CDC is one of the major operating components of the Department of Health and Human Services. View CDC’s Official Mission Statements/Organizational Charts to learn more about CDC′s organizational structure. </p>
		</div>
	</div>
	<!--//banner-bottom-->
	<!--features-->
	<div class="features">
		<div class="container">
			<div class="col-md-6 feature-grids">
				...
				<p>CDC works 24/7 to protect America from health, safety and security threats, both foreign and in the U.S. Whether diseases start at home or abroad, are chronic or acute, curable or preventable, human error or deliberate attack, CDC fights disease and supports communities and citizens to do the same.</p>
			...
			<div class="col-md-6 feature-grids">
				...
				<div class="pince">
					...
					<div class="pince-right">
						...
						<p>CDC has always been there saving lives and uplifting the people.</p>
					</div>
	...
	<div class="projects">
		<div class="container">
			<div class="col-md-3 project-right ">
				...
				<p>&nbsp;</p>
				<p>CDC is always on the move. Helping people and nations.</p>
			</div>
