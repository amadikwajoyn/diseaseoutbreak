		...
		<div class="container">
			...
			<div class="servcs-info">
				<div class="col-md-12 sevcs-grids">
					...
					<p>CDC’s Center, Institute, and Offices (CIOs) allow the agency to be more responsive and effective when dealing with public health concerns. Each group implements CDC′s response in their areas of expertise, while also providing intra-agency support and resource-sharing for cross-cutting issues and specific health threats.</p>			
				</div>
